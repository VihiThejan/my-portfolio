...
export function Hero() {
  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <motion.div
        style={{ opacity, scale }}
        className="relative z-10 text-center px-4 sm:px-6 lg:px-8 w-full hero-laptop-optimize pt-20 lg:pt-24"
      >
        <div className="hero-content max-w-4xl lg:max-w-5xl mx-auto">
